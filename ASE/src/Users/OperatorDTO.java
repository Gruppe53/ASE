...
public class OperatorDTO implements IOperatorDTO {
	...
	public String getName(String opr) {
		for (int i = 0; i < oprs.size(); i++)
			if(oprs.get(i).opr.equals(opr))
				return oprs.get(i).name;
		return null;
	}
	

	public int getOprId(String opr) {
		for (int i = 0; i < oprs.size(); i++)
			if(oprs.get(i).opr.equals(opr))
	...
	public String getPassword(String opr) {
		for (int i = 0; i < oprs.size(); i++)
			if(oprs.get(i).opr.equals(opr))
	...
	private int getIndex(String opr) {
		for(int i = 0; i < oprs.size(); i++)
			if(oprs.get(i).opr.equals(opr))
				return i;
